...
export const MaterialForm = ({ initialData, categories, colors, sizes, }) => {
  ...
  console.log('initialllllllllll', initialData)
  ...
  const handleSubmit = async (e) => {
    try {
      setLoading(true)
      if (initialData) {
        await axios.patch(`/api/${params.storeId}/products/${params.materialId}`, {
          name: value && value,
  ...
  const onDelete = async () => {
    try {
      setLoading(true)
      await axios.delete(`/api/${params.storeId}/products/${params.materialId}`)
      router.refresh()
      router.push(`/${params.storeId}/materials/`)
